...
Route::get('article/search','ArticleController@searchArticle');
Route::get('article/search_article_from_multi_sources','ArticleController@searchArticleFromMultiSources');
...
Route::post('author/update','AuthorController@update')->middleware('auth:api'); 
